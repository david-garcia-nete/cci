...
require_once __DIR__ . '/../examples/pg116_monochrome_screen.php';
...
$MonochromeScreenTest = new MonochromeScreenTest();
$MonochromeScreenTest->testDrawLineOn16x16Screen();
$MonochromeScreenTest->testDrawLineOn32x8Screen();
